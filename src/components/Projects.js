...
const Projects = () => (
    <>
        ...
        <img className="scroll up" src={ scrollUp } alt="Scroll up arrow" />
            <header className="cardsHeading">
                <h2 className="cardGroupHeading">Projects</h2>
            </header>
            <section className="cardGroup">
                <section className="cardSnap snap800">
                    <img className="scrollSnap up" src={ scrollUp } alt="Scroll up arrow" />
                    ...
                    <img className="scrollSnap down" src={ scrollDown } alt="Scroll down arrow" /> 
                </section>
                <section className="cardSnap snap800">
                    <img className="scrollSnap up" src={ scrollUp } alt="Scroll up arrow" />
                    <header className="cardsSnapHeading">
            ...
            <img className="scroll down" src={ scrollDown } alt="Scroll down arrow" /> 
        </main>
    </>
);
